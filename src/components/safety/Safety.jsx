import { DiyaDescr, DiyaWrap, InfoWrapper, SafetyTitle, SafetyWrapper, UserDescr, UserWrap, ImgWrap } from "./Safety.styled";
import DiyaImg from '../img/Diya.jpg'
import Soldier from '../img/vector-soldier.jpg'
import { FundsTexts, TitleFunds } from "components/oportunity/parts/Funds.styled";
            ...
            <InfoWrapper>
                ...
                <UserWrap>
                    ...
                    <DiyaDescr>
                        ...
                        <FundsTexts>
                        Підвтерджємо актуальність запиту та особу
                        </FundsTexts>
                    </DiyaDescr>
                </UserWrap>
                <UserWrap>
                    ...
                    <DiyaDescr>
                        ...
                        <FundsTexts>
                        Ознайомлюємось з волонтерською діяльністью
                        </FundsTexts>
                    </DiyaDescr>
                </UserWrap>
                <UserWrap>
                    ...
                    <DiyaDescr>
                        ...
                        <FundsTexts>
                        Слідкуємо за коректністью звітування
                        </FundsTexts>
                    </DiyaDescr>
                </UserWrap>
            </InfoWrapper>
